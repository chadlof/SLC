        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
                        <h2>Please enter referral infromation</h2>
                      <form action="form.php" method="post">
                        <p><label for="Cname">Company Name:</label>
                        <input type="text" name="Cname" id="Cname"></p>
                        <p><label for="Ename">Employee Name:</label>
                        <input type="text" name="Ename" id="Ename"></p>
                        <p><label for="Cuname">Customer Name:</label>
                        <input type="text" name="Cuname" id="Cuname"></p>
                        <input type="hidden" name="othertxt" value="<?php echo $Othertxt; ?>">
                        <input type="hidden" name="answer" value="<?php echo $OnlineAnswer; ?>">
