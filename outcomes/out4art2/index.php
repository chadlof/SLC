        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <h1 class="brand-heading">ABC Stone inc.</h1>
              <p class="intro-text">For when you need more <b>Rocks</b> in your life!
                <br>Created by Chad Lofgren</p>
        ...
        <div class="row">
          ...
          <form action="signin.php" method="post">
            <div class="comtent" align="">
                <div class="box">
                    <h2>Have you visited the ABC Stone company befor?</h2>
                    <p><input type="radio" name="answer" id="c1" value="yes">
                    <label for="c1">Yes</label></p>
                    <p><input type="radio" name="answer" id="c2" value="no">
